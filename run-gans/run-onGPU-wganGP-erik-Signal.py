...
for channel in all_channels:
    for key, value in mapping.items():
        ...
        save_result_path = 'results/WGanGP_Signal_EEG_samples/' + str(subject_id) + '/' + tasks_name + '/' + channels_name
        if not os.path.exists(save_result_path):
            os.makedirs(save_result_path)

        save_model_path = '../saved_models/WGan-Gp-Signal/' + str(subject_id) + '/' + tasks_name + '/' + channels_name

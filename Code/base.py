...
def create_model_deep4(input_window_samples, n_chans=4, n_classes=4, final_conv_length=2):
    model = Deep4Net(
        in_chans=n_chans,
        n_classes=n_classes,
        input_window_samples=input_window_samples,
...
def create_model_deep4_auto(input_window_samples=None, n_chans=4, n_classes=4):
    model = Deep4Net(
        in_chans=n_chans,
        n_classes=n_classes,
        input_window_samples=input_window_samples,

...
def zmax_normalize_preprocess(dataset, low_cut_hz=4., high_cut_hz=38.):
    C_22_sensors = [
        'FC1', 'FC2',
        'C3', 'Cz', 'C4',
        'CP1', 'CP2',
...
def stdmax_normalize_preprocess(dataset, low_cut_hz=4., high_cut_hz=38.):
    C_22_sensors = [
        'FC1', 'FC2',
        'C3', 'Cz', 'C4',
        'CP1', 'CP2',
    ...
    moving_fn = {'standardize': exponential_moving_standardize}[exponential_moving_fn]
...
def tanh_normalize_preprocess(dataset, low_cut_hz=4., high_cut_hz=38.):
    C_22_sensors = [
        'FC1', 'FC2',
        'C3', 'Cz', 'C4',
        'CP1', 'CP2',
    ...
    normal_fn_name = 'tanh'
    normal_fn = {'tanh': tanhNormalize}[normal_fn_name]

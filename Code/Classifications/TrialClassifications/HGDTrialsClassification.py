...
from Code.base import plot, split_hgd_into_train_valid, get_results, detect_device, \
    cut_trial_windows
...
def run_model(dataset, model, phase, save_path):
    ...
    train_set, test_set = split_hgd_into_train_valid(windows_dataset, use_final_eval=True)

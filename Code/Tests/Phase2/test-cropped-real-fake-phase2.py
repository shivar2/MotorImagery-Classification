...
def test_clf(data_load_path, clf_load_path, save_path):
    ...
    print("EEG Classifications Score (Accuracy) is:  " + str(score))
...
########################################
#   Test Cropped And Fake Classifications
########################################
...
for subject_id in subject_id_list:
    # for fake_ind in range(0, 6):
        ...
        clf_load_path = os.path.join('../../../Model_Params/BCI_Models/0-38/' +
        ...
        save_path = os.path.join('../../../Result/BCI_Models/0-38/' +
                                     'deep4/' + 'phase2' + ' - ' + 'normalize/' +
                                     str(subject_id)) + '/'

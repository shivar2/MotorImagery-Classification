...
from Code.Classification.TLClassificationOneLeaveOut import run_model
...
# Save results
save_path = os.path.join('../../../Result/TL_Classification/22/' + str(subject_id_train_list).strip('[]')) + '/Run-num:0/'
